...
function App({viewBirdArray}) {
  ...
  return (
    <div className="App">
       <p className="header">Enter a comma separated list into input box. Click Add to see new results. (Numbers in data set represent individual species sightings)</p>
